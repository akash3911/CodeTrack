        ...
        <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-14">
          <section className="animate-rise ui-surface p-8 md:p-12">
            <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr] md:items-center">
              <div>
                <span className="mb-5 inline-block rounded-md border border-[#ffc02e]/30 bg-[#ffc02e]/10 px-3 py-1 font-heading text-xs font-bold uppercase tracking-[0.12em] text-[#ffc02e]">
                  Coding Practice App
                </span>
